...
<div class="container relative">
	<PageHeader.Root class="pb-8">
		<!-- <Announcement /> -->
		<PageHeader.Heading>Sigma sdk</PageHeader.Heading>
		<PageHeader.Description class="text-muted-foreground">
			Componentes diseñados para integrarse en tus aplicaciones. Accesibles, personalizables, y de código abierto.
		...
		<div class="flex w-full items-center justify-center space-x-4 py-4 md:pb-10">
			<a href="/docs/components" class={cn(buttonVariants())}>Comenzar </a>
			<!-- <a
				target="_blank"
				rel="noreferrer"
